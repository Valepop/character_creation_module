...
def attack(char_name: str, char_class: str) -> str:
    """Возвращяет очки атаки в зависимости от выбранного класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращяет очки защиты в зависимости от выбранного класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращяет очки специального умения в зависимости от класса."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предлагает игроку ввести его имя и дает на выбор персонажа."""
    approve_choice = None
    char_class = None
